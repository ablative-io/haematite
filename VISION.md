...
5 of 25 briefs landed. 55 tests. The core tree primitives, cursor operations, structural diff, disk persistence with zstd compression, and LRU caching are complete. WAL buffer and the critical path through shard actors are next.
